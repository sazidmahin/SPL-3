...
- Goal: Initializes the frontend using Yarn, React, TypeScript, and Vite. This provides the base frontend application where authentication, dashboard, Draw.io editor, SRS pages, and billing pages will be built.
