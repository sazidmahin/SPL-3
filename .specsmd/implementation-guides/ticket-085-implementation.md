# TICKET-085 Implementation

## Overview

- Ticket: TICKET-085
- Sprint: Sprint 11 - Export, Permissions, and Polishing
- Title: Upgrade Prompt UI
- Feature: Subscription upgrade messaging
- Goal: Shows a clear upgrade prompt when a user tries to use paid features without an active paid subscription.
