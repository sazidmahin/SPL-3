...
- Goal: Allows users to log in and receive an access token for authenticated API requests.
...
- Define the backend data structures and schemas required for Login and token generation, keeping field names aligned with the auth and workspace specs.
