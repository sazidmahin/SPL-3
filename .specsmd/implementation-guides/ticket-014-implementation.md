...
- Title: Workspace Members Model
- Feature: Workspace membership and roles
- Goal: Creates the `workspace_members` table and model. Tracks user access to workspaces with roles such as owner, admin, member, and viewer.
