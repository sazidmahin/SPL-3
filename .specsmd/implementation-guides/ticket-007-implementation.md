...
- Goal: Allows a new user to create an account using email, password, and name. Passwords must be hashed before storing.
...
- Define the backend data structures and schemas required for Register new user, keeping field names aligned with the auth and workspace specs.
