...
- Goal: Adds APIs for listing plans, viewing workspace subscription, viewing current usage, and creating a checkout session for later billing-provider integration.
