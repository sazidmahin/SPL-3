...
- Goal: Returns the currently logged-in user and their available workspaces.
...
- Define the backend data structures and schemas required for Get authenticated user, keeping field names aligned with the auth and workspace specs.
