...
- Goal: Automatically creates a personal workspace whenever a new user registers. This allows users to work even if they are not part of any organization.
...
- Define the backend data structures and schemas required for Automatic personal workspace, keeping field names aligned with the auth and workspace specs.
